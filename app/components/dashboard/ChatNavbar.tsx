        ...
        <div className="flex min-w-0 items-center gap-2">
          {backHref ? (
            ...
            <button
              type="button"
              onClick={() => router.back()}
              className="inline-flex cursor-pointer h-10 w-10 items-center justify-center rounded-xl border border-transparent hover:border-slate-200 bg-white text-slate-700 shadow-[0_1px_0_rgba(15,23,42,0.04)] hover:bg-slate-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-300"
              aria-label="Back"
              title="Back"
            >
              <ChevronLeft className="h-5 w-5 hover:scale-110 transition-all duration-300" />
            </button>
          )}
